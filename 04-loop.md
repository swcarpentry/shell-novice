...
> ## Putting it together: Using filters in loops to output "clean" data
>
> We're going to output some information from these PDB files while ommitting other parts. This is useful because when working with data, we often need to strip parts so that we only have the useful stuff!
> ~~~
...
> do
>    echo $molecule  
>    grep " C " $molecule | awk '{print $5 ", " $6 ", " $7}'
> done
>
> ~~~
