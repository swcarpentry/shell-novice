...
Here are some fun facts abut UNIX:

Unix development started in 1996. 
It was created by developers for developers. 
Unix was designed to be simple and powerful.

Unix Shell Scripting is getting more and more popular because of its robust scope.
It is a powerful programming method that can help you learn the command line better, save time and do away with tedious file management tasks.
In addition, with the rising requirements for speedy processing of huge amounts of data generated by applications, UNIX is used more than ever to significantly reduce the turnaround time for the job.
