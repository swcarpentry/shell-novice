...
it changes the shell's idea of what directory we are in. The 'cd' command is akin to double clicking a folder in a graphical interface to get into a folder.
